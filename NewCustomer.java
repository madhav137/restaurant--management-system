...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
                ...
                setBounds(280, 80, 850, 550);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                setResizable(false);
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("restaurant/management/system/icons/fifth.png"));
		...
		JLabel lblReserveRoomNumber = new JLabel("ALLOCATED TABLE NUMBER :");
		...
		contentPane.add(lblReserveRoomNumber);
                ...
                try{
                    ...
                    while(rs.next()){
                        c1.add(rs.getString("table_number"));    
                    }
                }catch(Exception e){ }
