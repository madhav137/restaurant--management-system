...
public class Room extends JFrame {
	...
	public Room() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("restaurant/management/system/icons/mm-5.jpg"));
		...
		btnLoadData.addActionListener((ActionEvent e) -> {
                    try{
                        conn c = new conn();
		...
		lblNewLabel_1 = new JLabel("TABLE TYPE");
		lblNewLabel_1.setBounds(417, 15, 76, 14);
		contentPane.add(lblNewLabel_1);

		
		lblId = new JLabel("TABLE NUMBER");
