...
public class CheckOut extends JFrame{
	...
	public CheckOut() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("restaurant/management/system/icons/sixth.jpg"));
		...
		contentPane.add(c1);
                ...
                ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("restaurant/management/system/icons/tick.png"));
                    ...
                    public void actionPerformed(ActionEvent ae){
                        ...
                        try{
                            ...
                            if(rs.next()){
                                ...
                                t1.setText(rs.getString("tables"));    
                            }
                        }catch(Exception e){ }
                    }
                });
		...
		JLabel lblRoomNumber = new JLabel("TABLE NUMBER:");
		...
		btnCheckOut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String deleteSQL = "Delete from customer where number = "+id;
                                String q2 = "update room set available = 'Available' where table_number = "+s1;
